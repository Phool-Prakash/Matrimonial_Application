...
import 'package:matrimonial_app/components/container_with_icon.dart';
import 'package:matrimonial_app/components/custom_popup.dart';
import 'package:matrimonial_app/components/my_circular_indicator.dart';
...
import 'package:matrimonial_app/middleware/profile_view_middleware.dart';
...
import 'package:matrimonial_app/redux/libs/home/home_action.dart';
...
import 'package:matrimonial_app/redux/libs/report/report_middleware.dart';
...
import 'package:matrimonial_app/screens/search_screens/search.dart';
...
class _HomeState extends State<Home> {
  ...
  Widget buildNameRow(List<dynamic> members, int index, HomeViewModel vm) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Row(
            ...
            Row(
              children: [
                CommonWidget.social_button(
                    ...
                    onpressed: () {
                      isLogin
                          ? NavigatorPush.push(context, Notifications())
